...
const uint16_t PROGMEM alt[] = {LT(2,KC_A), KC_S, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_FUNCTION] = LAYOUT_split_3x5_3(
    ...
    KC_X,           KC_3,     KC_B,        KC_F,    KC_Z,             KC_0,      KC_1,   KC_2,   KC_3,  KC_PSLS,
                                  TG(1),  KC_LALT, KC_SPC,            TG(1),   KC_ENT, XXXXXXX
  ),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [LAYER_FUNCTION]   = {ENCODER_CCW_CW(KC_LEFT, KC_RGHT),    ENCODER_CCW_CW(KC_UP, KC_DOWN)},
