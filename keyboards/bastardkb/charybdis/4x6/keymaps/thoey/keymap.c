...
const uint16_t PROGMEM y2[] = {LT(1,KC_SPC), RSFT_T(KC_J), COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT(
        ...
        CW_TOGG,    KC_U,       KC_W,  KC_E,   KC_R,         KC_T,                  KC_Y,          KC_U,          KC_I,       KC_O,    KC_RGUI,       KC_BSLS,
        KC_Q,       LT(3,KC_A), KC_S,  KC_D,   LSFT_T(KC_F), KC_G,                  KC_H,          RSFT_T(KC_J),  LT(3,KC_K), KC_L,    LT(1,KC_SCLN), RALT_T(KC_P),
        KC_LGUI,    KC_Z,       KC_X,  KC_C,   KC_V,         KC_B,                  RALT_T(KC_N),  KC_M,          KC_COMM,    KC_DOT,  LT(3,KC_SLSH), KC_ENT,
  ...
  [LAYER_LOWER] = LAYOUT(
       ...
       KC_LCTL, KC_X,   KC_3,    KC_LSFT, KC_F,    KC_5,             KC_0,      KC_1,    KC_2,    KC_3,    KC_PSLS, KC_DOT,
                                  ...
                                  KC_Z, KC_SPC, KC_LALT,        XXXXXXX, KC_BSPC,
                                           KC_B, KC_Y,          KC_P0
  ...
  [LAYER_POINTER] = LAYOUT(
       ...
       POINTER_DEFAULT_DPI_REVERSE, POINTER_DEFAULT_DPI_FORWARD, KC_WBAK, MS_UP,   KC_WFWD,       C(A(KC_DEL)),           C(A(KC_DEL)), C(KC_T),    XXXXXXX,  C(KC_W),         KC_BTN3,       KC_RGUI,
       XXXXXXX,                     XXXXXXX,                     MS_LEFT, MS_DOWN, MS_RGHT,       MS_WHLU,                C(KC_F),      KC_BTN1,    KC_HOME,  RSFT_T(KC_BTN2), OSM(MOD_RCTL), OSM(MOD_RSFT),
       DRGSCRL,                     XXXXXXX,                     DRGSCRL, SNIPING, XXXXXXX,       MS_WHLD,                KC_F5,        KC_WFWD,    KC_END,   KC_WBAK,         KC_RSFT,       G(KC_D),
