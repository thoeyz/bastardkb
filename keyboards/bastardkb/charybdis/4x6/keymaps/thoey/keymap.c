...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT(
        ...
        KC_MS_BTN1, KC_MS_BTN2, KC_F2, KC_ENT, S(KC_9),      S(KC_0),               KC_EQL,    KC_7,    KC_ENT,    RGB_TOG,    TG(1), TG(2),
  ...
  [LAYER_RAISE] = LAYOUT(
       ...
       KC_MPLY, KC_RBRC,  KC_LEFT, KC_UP, KC_RGHT, KC_HOME,          XXXXXXX, KC_RSFT, KC_RCTL, KC_RALT, KC_RGUI, KC_MUTE,
