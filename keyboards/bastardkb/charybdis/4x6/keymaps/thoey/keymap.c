...
const uint16_t PROGMEM Ralt[] = {KC_I, KC_O, COMBO_END};
const uint16_t PROGMEM f5[] = {KC_BTN1, KC_BTN2, COMBO_END};
const uint16_t PROGMEM esc[] = {KC_V, KC_B, COMBO_END};
const uint16_t PROGMEM Resc[] = {RALT_T(KC_N), KC_M, COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT(
        ...
        KC_MS_BTN1, KC_MS_BTN2, KC_F2, KC_ENT, KC_LPRN,      KC_RPRN,               RGB_TOG,       KC_7,          KC_ENT,     XXXXXXX, CW_TOGG,       TG(1),
        CW_TOGG,    KC_U,       KC_W,  KC_E,   KC_R,         KC_T,                  KC_Y,          KC_U,          KC_I,       KC_O,    KC_TAB,        KC_BSLS,
        KC_Q,       LT(3,KC_A), KC_S,  KC_D,   LSFT_T(KC_F), KC_G,                  KC_H,          RSFT_T(KC_J),  LT(3,KC_K), KC_L,    LT(1,KC_SCLN), RALT_T(KC_P),
        DRGSCRL,    KC_Z,       KC_X,  KC_C,   KC_V,         KC_B,                  RALT_T(KC_N),  KC_M,          KC_COMM,    KC_DOT,  LT(3,KC_SLSH), KC_ENT,
  
                             LT(1,KC_TAB), LCTL_T(KC_BSPC), MO(2),                 RCTL_T(KC_TAB), LT(1,KC_SPC),
                                                KC_BTN1, KC_BTN2,                  A(KC_LSFT)
  ),

  [LAYER_LOWER] = LAYOUT(
       KC_TAB,  KC_O,   KC_F2,   KC_I,    KC_LEFT, KC_RGHT,          KC_CIRC,   KC_AMPR, KC_ENT,  KC_LPRN, KC_TRNS, KC_TRNS,
       KC_ENT,  KC_ESC, KC_LSFT, KC_W,    KC_C,    KC_R,             KC_MINS,   KC_7,    KC_8,    KC_9,    KC_RBRC, KC_TAB,
       KC_LSFT, KC_E,   KC_A,    KC_S,    KC_D,    KC_G,             KC_PPLS,   KC_4,    KC_5,    KC_6,    KC_PAST, KC_BSPC,
  ...
  [LAYER_POINTER] = LAYOUT(
       ...
       POINTER_DEFAULT_DPI_REVERSE, POINTER_DEFAULT_DPI_FORWARD, KC_WBAK, MS_UP,   KC_WFWD,       C(A(KC_DEL)),           XXXXXXX, C(KC_T),    XXXXXXX,  C(KC_W),         KC_BTN3,       KC_RGUI,
       XXXXXXX,                     XXXXXXX,                     MS_LEFT, MS_DOWN, MS_RGHT,       MS_WHLU,                XXXXXXX, KC_BTN1,    KC_HOME,  RSFT_T(KC_BTN2), OSM(MOD_RCTL), OSM(MOD_RSFT),
       DRGSCRL,                     XXXXXXX,                     DRGSCRL, SNIPING, XXXXXXX,       MS_WHLD,                KC_F5,   KC_WFWD,    KC_END,   KC_WBAK,         KC_RGUI,       XXXXXXX,
 ...
 [LAYER_ONEHANDED] = LAYOUT(
       ...
       XXXXXXX, KC_P,    KC_O,    KC_I,    KC_U,          KC_Y,               KC_T,    KC_R,         KC_E,    KC_W,    KC_T,    OSM(MOD_RALT),
       XXXXXXX, XXXXXXX, KC_L,    KC_K,    LSFT_T(KC_J),  KC_H,               KC_G,    RSFT_T(KC_F), KC_D,    KC_S,    KC_A,    KC_Q,
       XXXXXXX, XXXXXXX, XXXXXXX, KC_P,    KC_M,          KC_N,               KC_B,    KC_V,         KC_C,    KC_X,    KC_Z,    KC_BSPC,
 ...
 [LAYER_RNUM] = LAYOUT(
       ...
       XXXXXXX, XXXXXXX, XXXXXXX, KC_LGUI, XXXXXXX, QK_BOOT,            QK_BOOT, S_D_MOD, DPI_MOD, SNIPING, KC_MPRV, KC_MNXT,
       XXXXXXX, KC_PAST, KC_7,    KC_8,    KC_9,    KC_MINS,            XXXXXXX, XXXXXXX, KC_UP,   XXXXXXX, XXXXXXX, XXXXXXX,
       XXXXXXX, KC_PSLS, KC_4,    KC_5,    KC_6,    KC_PPLS,            KC_VOLU, KC_LEFT, KC_DOWN, KC_RGHT, KC_RCTL, KC_RGUI,
       XXXXXXX, KC_DOT,  KC_1,    KC_2,    KC_3,    KC_0,               KC_VOLD, A(KC_V), A(KC_D), A(KC_S), A(KC_A), KC_MUTE,
