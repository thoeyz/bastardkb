...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [LAYER_POINTER] = LAYOUT(
       ...
       XXXXXXX,                     XXXXXXX,                     MS_LEFT, MS_DOWN, MS_RGHT,       MS_WHLU,                XXXXXXX, KC_BTN1,    KC_HOME,  RSFT_T(KC_BTN2), KC_RCTL, OSM(MOD_RSFT),
       DRGSCRL,                     XXXXXXX,                     DRGSCRL, SNIPING, XXXXXXX,       MS_WHLD,                KC_F5,   KC_WFWD,    KC_END,   KC_WBAK,         KC_RGUI, DRGSCRL,
